				...
				<div class="col-md-4 contact-information">
					<div class="inner">
						...
						<?php endif; ?>
							...
							<!-- Contact -->
							<?php if ($this->params->get('show_info', 1) || $tparams->get('show_links') || $tparams->get('show_articles') && $this->contact->user_id && $this->contact->articles) : ?>
							<div class="contact-info">
								...
								<?php if ($tparams->get('show_articles') && $this->contact->user_id && $this->contact->articles) : ?>
					        <div class="contact-articles-title"><h2><?php echo JText::_('JGLOBAL_ARTICLES');?></h2></div>
					        <?php echo $this->loadTemplate('articles'); ?>
						  	<?php endif; ?> <!-- // Show articles -->
							</div>
							<!-- End contact-->
