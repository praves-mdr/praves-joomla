...
?>
<div class="com-content-article item-page project-page <?php echo $this->pageclass_sfx; ?>" itemscope itemtype="https://schema.org/Article">
	...
	<?php if (!$useDefList && $this->print) : ?>
		<div id="pop-print" class="btn hidden-print">
			<?php echo HTMLHelper::_('icon.print_screen', $params); ?>
		</div>
		<div class="clearfix"> </div>
	<?php endif; ?>
	<?php if ($params->get('show_title') || $params->get('show_author')) : ?>
	<div class="page-header">
		<?php if ($params->get('show_title') && !$document->countModules('masthead') ) : ?>
	...
	<?php if ($useDefList && ($info == 0 || $info == 2)  && !$document->countModules('masthead') ) : ?>
