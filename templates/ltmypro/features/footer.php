...
class HelixUltimateFeatureFooter
{
	...
	public function renderFeature()
	{
		if($this->params->get('enabled_copyright'))
		{
			...
			{
				$output .= '<span class="sp-copyright">' . str_ireplace('{year}',date('Y'), str_ireplace('ltheme', '<a target="_blank" href="https://www.ltheme.com">ltheme</a>', $this->params->get('copyright'))) . '</span>';
			}
