...
?>
<link rel="stylesheet" type="text/css" href="<?php echo $mosConfig_live_site; ?>/modules/mod_pretty_testimonial_responsive_slider/tmpl/testimonial_slider/css/style.css">
<?php
if ($enable_jQuery == 1) {?>
	<script type="text/javascript" src="<?php echo $mosConfig_live_site; ?>/modules/mod_pretty_testimonial_responsive_slider/tmpl/testimonial_slider/js/jquery.min.js"></script>
<?php }?>
<script type="text/javascript" src="<?php echo $mosConfig_live_site; ?>/modules/mod_pretty_testimonial_responsive_slider/tmpl/testimonial_slider/js/testimonial.slider.js"></script>
<style>
