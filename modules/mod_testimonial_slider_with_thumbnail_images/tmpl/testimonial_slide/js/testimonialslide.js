jQuery(document).ready(function($){
	$('#testimonial-slide-thumb-img').testimonialslide({
		 layout: 'slider', 
		 ...
		 slideSpeed: 600, 
		 style: 'shadow', 
		 customNavs: ['#jhm-thumbs', '.jhm-thumb'],
		 thumbsBG  : false,
		 customStyle : [
			'#testimonial-slide-thumb-img .jhm-slide{padding: 105px 0; font-size: 16px;}', 
			'#testimonial-slide-thumb-img .jhm-slide p{text-align: center, text-shadow: none;}',
			'#testimonial-slide-thumb-img .jhm-slide h3{font-size: 1.3rem;}'
		 ]
	});
	$('#testimonial-slide-thumb-img').append( '<div style="color: black;text-align:center;font-size:18px;padding-bottom:10px;">Extension by <a href="http://joomhome.com">Joomhome</a></div>' );
}); 
...
/** 
  * testimonialslide Slider jQuery Plugin
...
!(function( $ ){
    ...
    $.fn.testimonialslide = function(options){ 
         //setting defaults
         var settings = $.extend({
              layout      : 'default',
              ...
              markup      : ['.jhm-container', '.jhm-slide'],
              width       : '65%',
              height      : '320px',
              margin      : '60px',
              fullWidth   : false,
      ...
      var screenSlide = {
       ...
       if( settings.layout === 'default' ){
              ...
              if( !$(this).hasClass('active') && wait === 0 ){
                 ...
                 if( parseInt(Index) > parseInt(prevIndex) ){
                       ...
                       parent.find(prev).one(animationEvent, function(event) {
                          ...
                          if( $('.testimonialslide_slider.hand .hgi.active').length > 1 ){ 
                             prev.removeClass('active');
                          } 
                          wait = 0;
                       });
          ...
          if( settings.customNavs[0] === '#jhm-thumbs' ) {
          	  screenSlide.thumbs();
          }
          ...
          if( settings.thumbsBG === false ){
              parent.find('#jhm-thumbs').addClass('no-bg');
           } 
