...
*/
    ...
    class mod_Prettytestimonialressliderjbb
    {    
        ...
        */
        public function generate()
        {
            ...
            {
                $className = 'jbb'.ucfirst($class['source']).'Helper';
        ...
        * @param string $style
        * @return mod_Prettytestimonialressliderjbb
        */
        ...
        */
        ...
        private function onDataError($params)
        {
            if(  empty($params['data'])  )
            {
                ...
                $this->setError('This module Cann\'t get any slider data to generate slide in module  "'. $this->module_name.'".
								<br>Solution: Please insert data for parameter at tab "Config item".
								<br>Thank you!');
            }
        }
        ...
        */
        public function Num2Lang($number, $prefix = 'jbb_')
        {
