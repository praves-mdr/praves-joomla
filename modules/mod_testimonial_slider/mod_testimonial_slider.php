...
$style                   = $params->get('jbb_style');

if( empty($style) )
{
    JFactory::getApplication()->enqueueMessage( 'Slider style no declared. Check testimonial slider configuration and save again from admin panel' , 'error');
    return;
}
...
$helper = new mod_Prettytestimonialressliderjbb($params, $module_id);
...
$header_module 			= $params->get('header_module', "testimonial slider");
