...
class Settings{
	...
	static public function getRowSettings(){
	...
	static public function getColSettings(){
        $tplXml = T4PATH_TPL . '/templateDetails.xml';
        // new form
	...
	static public function getMegaRowConfig(){
        $tplXml = T4PATH_TPL . '/templateDetails.xml';
        // new form
	...
	static public function getMegaItemSettings(){
    	$tplXml = T4PATH_TPL . '/templateDetails.xml';
        // new form
        $xmlfile = \T4\Helper\Path::findInTheme('params/megamenu.xml');
	...
	static public function renderFieldsetStart($fieldset){
	...
	static public function renderFieldsetEnd()
    {
        return '</div></div>';
    }


    static public function renderGroups($groups)
    {
        $html = '';
    ...
    static public function renderGroupStart( $group )
    {
    	if($group == 'col') $group = 'general';
    ...
    static public function renderGroupEnd()
    {
        return '</div></div>';
    }
    ...
    static public function renderInputField($field = '', $group = '')
    {
        ...
        if(!$field->getAttribute('hideLabel')) {
           $field_html .= '<div class="control-label">' . str_replace('</label>', ' <span class="hasTooltip fal fa-question-circle"></span></label>',$field->label) .'</div>';
        }
